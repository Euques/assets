...
(function() {
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Lista582',
										'page_location': 'https://lista.inovabar.com.br/#lista582',
									});
								},
							],
						},
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										...
										'page_location': 'https://lista.inovabar.com.br/#promoter582',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Bday569',
										'page_location': 'https://lista.inovabar.com.br/#bday569',
									});
								},
							],
						},
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										...
										'page_location': 'https://lista.inovabar.com.br/#listageral',
									});
								},
							],
						},
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										...
										'page_location': 'https://lista.inovabar.com.br/#promoters',
									});
								},
							],
						},
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										...
										'page_location': 'https://lista.inovabar.com.br/#aniversariantes',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Drop',
										'page_location': 'https://lista.inovabar.com.br/#drop',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Admin258',
										'page_location': 'https://lista.inovabar.com.br/#admin258',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Menu',
										'page_location': 'https://lista.inovabar.com.br/#menu',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Noparty',
										'page_location': 'https://lista.inovabar.com.br/#noparty',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Script',
										'page_location': 'https://lista.inovabar.com.br/#script',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Home',
										'page_location': 'https://lista.inovabar.com.br',
									});
								},
							],
						},
	...
	// Buttons: buttons10.
		$('#buttons10 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
